 ...
 function highlightCountry(chart, legend, country) {
     ...
     chart.selectAll(".chart-point")
         .style("opacity", d => d.country === country ? 1 : 0.15)
         .attr("r", d => d.country === country ? 5 : 4);

     legend.selectAll(".legend-item")
         .style("opacity", d => d === country ? 1 : 0.35);
 }
 ...
 Promise.all([
     ...
     // Same country colours across all charts
     ...
     spendingByCountry.forEach(function(values, country) {
         ...
         chart2.append("path")
             ...
             .attr("class", "country-line spending-line")
             .attr("fill", "none")
             .attr("stroke", colourScale(country))
             .attr("stroke-width", 2.5)
             .attr("d", d => spendingLine(d.values))
         ...
         chart2.selectAll(null)
             ...
             .on("mouseover", function(event, d) {
                 highlightCountry(chart2, legend2, d.country);
     ...
     legendItems2.append("circle")
         ...
         .attr("cy", 0)
         .attr("r", 5)
         .attr("fill", country => colourScale(country));
     ...
     lifeByCountry.forEach(function(values, country) {
         ...
         chart3.append("path")
             ...
             .attr("class", "country-line life-line")
             .attr("fill", "none")
             .attr("stroke", colourScale(country))
             .attr("stroke-width", 2.5)
         ...
         chart3.selectAll(null)
             ...
             .attr("fill", colourScale(country))
             .on("mouseover", function(event, d) {
                 highlightCountry(chart3, legend3, d.country);
